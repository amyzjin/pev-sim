...
//  Value
    ...
    function test_fleet_sim() {
      ...
      // var filename = '/Results/trial_sim_hubway_data7147.JSON';
    ...
    function render(data) {
      // debugger;
      document.getElementById('svgContainer').innerHTML = '<svg id="graph" width="300" height="180"></svg>';
      var svg = d3.select("svg#graph"),
      margin = {top: 10, right: 60, bottom: 30, left: 40},
      width = svg.attr("width") - margin.left - margin.right,
      height = svg.attr("height") - margin.top - margin.bottom,
      g = svg.append("rect").attr("fill", "black")
      .attr("width", "100%")
      .attr("height", "100%"),
      g = svg.append("g")
      ...
      z = d3.scale.category20();//ordinal(d3.schemeCategory10);
...
return new Promise(function(resolve, reject) {
  // $.getJSON('/Variables/Variable_7.json',function(json){


  // $.getJSON('/Variables/Variable_'+(ran_nums['num']--)+'.json',function(json){
  $.getJSON('/Variables/Variable_'+(counter--)+'.json',function(json){
      code = json.Code
